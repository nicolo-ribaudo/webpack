...
/** @typedef {import("../declarations/WebpackOptions").DeferImportExperimentOptions} DeferImportExperimentOptions */
...
/**
 * @typedef {Object} DependencyCheckMode
 * @property {boolean} useSyncAssertion
 * @property {false | DeferImportExperimentOptions} deferModuleMode
 */
/**
 * @typedef {DependencyCheckMode & { strictExportPresence?: boolean }} HarmonyDependencyCheckMode
 */
