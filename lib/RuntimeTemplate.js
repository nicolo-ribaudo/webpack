...
class RuntimeTemplate {
	...
	exportFromImport({
		...
		const deferImportAcceptIndirectAsyncModule =
			...
			this.compilation.options.experiments.deferImport.asyncModule ===
				"proposal";
